...
func TestPatchBanner(t *testing.T) {
	...
	for i := range 30 {
		req, err := http.NewRequest("PATCH", host+"/banner/"+fmt.Sprint(i), bytes.NewBuffer(data))
